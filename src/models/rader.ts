...
export let raderInfo: RaderInfo = {
  airplanes: [
    // { id: 'a', x: 100, y: 100, heading: 180, targetHeading: null },
    { id: 'b', x: 200, y: 100, heading: 350, targetHeading: { direction: 'right', to: { type: 'heading', heading: 180 }, reached: false } },
    // { id: 'c', x: 300, y: 200, heading: 0, targetHeading: { direction: 'right', to: { type: 'coordinates', x: 0, y: 0 }, reached: false } },
  ],
  runways: [
